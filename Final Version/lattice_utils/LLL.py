...
basis = None  # Initialize the basis as the user input.
orthobasis = None  # Initialize the Gram-Schmidt basis.
...
def lovasz():
    ...
    if la.norm(orthobasis[k]) ** 2 >= np.dot(c, la.norm(orthobasis[k - 1] ** 2)):  # Checks the Lovasz condition.
